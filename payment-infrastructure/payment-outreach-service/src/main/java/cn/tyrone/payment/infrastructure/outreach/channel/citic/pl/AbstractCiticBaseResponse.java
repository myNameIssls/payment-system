...
import cn.tyrone.payment.infrastructure.outreach.channel.common.AbstractXmlBaseResponse;
...
@NoArgsConstructor
@AllArgsConstructor
public abstract class AbstractCiticBaseResponse extends AbstractXmlBaseResponse {
...
//        this.responsePlaintext = responseMessage;
        this.document = XmlUtil.createDocument(responseMessage);
